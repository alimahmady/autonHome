...
$sql = "INSERT INTO profile (name,Age,email,Address)
VALUES ('$Firstname','$Age','$EmailAddress','$Address')";
    ...
    <form class="form" action="" method="POST">
		<table>
			...
			<tr>
				...
				<td><input id="House_ID" name="House_ID" type="text" minlength="5" required></td>
			</tr>
			<tr>
				<td></td>
