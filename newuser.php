...
$uid2 = $new2sql["user_id"];

$sql2 = "INSERT INTO users (id,type,email,password,user_type) VALUES ($uid2,null,'$EmailAddress','$NewPwd','$UserType')";
    ...
    <body>
        ...
        <div class="rightcolumn">
			...
			<div class="main">
				...
				<div class="content">
					<br>
					<form class="form" method="POST" onsubmit="return checkPassword(this)">
					...
					<div class="rightcontent">
						<table>
							...
							<tr>
								...
								<td><input id="P1" name="NewPwd" type="password"></td>
							</tr>
							<tr>
								<td><label for="Confirm Password"><p align="left" >Confirm Password:</p></label></td>
								<td><input id="P2" name="confirmpassword" type="password"></td>
							</tr>
							<tr>
